...
| [docs/corne-keymaps.md](docs/corne-keymaps.md) | Keymap & layers reference: all 10 layers, home-row mods, sticky keys, layer-taps, pointing, OLED/ZMK Studio settings, and generated diagram workflow. |
| [docs/macos-aerospace.md](docs/macos-aerospace.md) | macOS AeroSpace tiling-window-manager guide: the Corne HOST/F13–F20 bridge, canonical config installation, workspace bindings, app routing, and troubleshooting. |
| `dotfiles/aerospace.toml` | Repository-tracked AeroSpace counterpart to the firmware HOST protocol. |
